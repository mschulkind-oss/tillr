...
var releaseNotesCmd = &cobra.Command{
	...
	Long: `Generate release notes from lifecycle project data.
...
EXAMPLES
  lifecycle release-notes --version v0.2.0
  lifecycle release-notes --milestone v1.0-production --version v1.0.0
  lifecycle release-notes --since 2025-01-01 --format markdown
  lifecycle release-notes --version v0.2.0 -o RELEASE_NOTES.md`,
...
func renderMarkdown(data releaseNotesData) string {
	...
	sb.WriteString(fmt.Sprintf("- %d features shipped\n", data.Stats.TotalFeatures))

	// Footer
	sb.WriteString(fmt.Sprintf("\n---\n_Generated by Lifecycle on %s_\n", time.Now().UTC().Format("2006-01-02")))
